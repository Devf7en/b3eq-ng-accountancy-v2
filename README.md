...
- `.vscode/` contains shared editor settings, recommended extensions, and workspace tasks.
- `b3eq-ng-accountancy-v2.code-workspace` is the cross-machine workspace file.
...
2. Open `b3eq-ng-accountancy-v2.code-workspace` in VS Code.
3. Install the recommended extensions if prompted.
4. Use the VS Code Tasks panel for common commands:
   - Docker Compose: Up
   - Docker Compose: Down
   - Docker Compose: Build dolibarr
   - Validate PHP module

This ensures every machine opening the project inherits the same workspace settings, handoff state, and `TODO.md` progress.
...
_b3Ɛq: Bodacious Business Builder · Exponential Quantum_
